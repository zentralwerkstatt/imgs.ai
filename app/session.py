...
class Session:
    ...
    def load_model(self, model_name):
        ...
        self.config["model_names"] = [model_name for model_name in models.keys() if (models[model_name].config["private"] == self.config["private"]) or (models[model_name].config["private"] == False)]
